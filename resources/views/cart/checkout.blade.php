...
<div class="row">
    <div class="col-lg-12">
     ...
     <div class="form-group">
         {{Form::label('postcode', 'Postcode',['class' => 'text-dark'])}}
         {{Form::text('postcode', null, ['class' => 'form-control', 'placeholder' => 'Postcode', 'required'])}}
      </div>
     <div class="form-group">
        {{Form::label('card', 'Name On Card',['class' => 'text-dark'])}}
        {{Form::text('card', null, ['class' => 'form-control', 'placeholder' => 'Name On Card', 'required'])}}
     </div>
     ...
     <br>
     <h5 class="text-dark">Total price: £{{$total}}</h5>
