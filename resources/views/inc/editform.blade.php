<div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
            ...
            {{Form::text('location',$book->location, ['class' => 'form-control', 'placeholder' => 'Location'])}}
     </div>
     ...
     {{-- <div class="form-group">
        {{Form::label('picture','Picture',['class' => 'text-dark'])}}
        <br>
        {{Form::file('picture')}}
     </div> --}}
     ...
     <div class="form-group">
            ...
            {{Form::text('price', $book->price, ['class' => 'form-control', 'placeholder' => '£'])}}
     </div>

     <div class="form-group">
            {{Form::label('type', 'Please specify the book type',['class' => 'text-dark'])}}
            {{Form::text('type', $book->type, ['class' => 'form-control', 'placeholder' => 'Type'])}}
     </div>
