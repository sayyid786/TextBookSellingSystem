...
<div class="row">
    @foreach($bookChunk as $book) @if($book->quantity > 0 && !Auth::guest() && Auth::user()->id === $book->user_id)
    <div class="col-lg-4">
        <div class="card h-100 text-center">
            <div class="card-body">
                ...
                <a href="#" class="btn btn-secondary disabled">£{{number_format($book->price,2)}}</a>
...
<br>
<br> @endforeach @endif {{$books->links()}} @include('inc.footer') @endsection