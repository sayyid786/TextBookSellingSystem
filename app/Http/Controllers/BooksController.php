...
class BooksController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            ...
            'type' => 'required',
            'ISBN' => ['required', 'regex:/((978[\--– ])?[0-9][0-9\--– ]{10}[\--– ][0-9xX])|((978)?[0-9]{9}[0-9Xx])$/'],
  ...
  /**
   ...
   public function postcheckout(Request $request){
    ...
    $this->validate($request,[
        ...
        'postcode' => 'required|regex:/[A-Z]{1,2}[0-9][0-9A-Z]?\s?[0-9][A-Z]{2}/',
    ]);
    ...
    try {
      ...
      Auth::user()->orders()->save($order);
        ...
        Session::forget('cart');
        return redirect('/books')->with('success', 'Book successfully purchased');
    }
